...
// import { getProduct, getProductRelated } from '../../../../services/products';
...
// import { whitelistCategoryToPartner } from '../../../../constants';
...
//   let shareUrl = host + router.asPath;

//   const linkWa = () => {
//     let result = `https://api.whatsapp.com/send?phone=${process.env.NEXT_PUBLIC_WA_NUMBER_3}`;
//     if (whitelistCategoryToPartner.includes(product.category[0].name)) {
//       result = `https://api.whatsapp.com/send?phone=${process.env.NEXT_PUBLIC_WA_NUMBER_2}`;
//     }
...
//   const dataProduct = await getProduct(query.id);
//   const dataProductRelated = await getProductRelated(query.id);
